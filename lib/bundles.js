...
function bundlResource (bundl, r, afterEach, afterAll, error) {
    ...
    function walk () {
        ...
        var iterator = extension.one || extension.each; // until we switch over all usages
    ...
    function eachDone (result) {
        ...
        if (typeof result === 'string') {
            ...
            bundl.log.error(new Error('Extension.one must return contents or call done(contents)'));
        }
    }
